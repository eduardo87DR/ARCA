...
<form action="insert\registro_clasificacion.php" method="post">
  <div class="mb-3">
    <label  class="form-label">Ingresa una Clasificación</label>
...
<!-- ========== End formulario ========== -->
  ...
  $c=1;
  $consulta = "call p_verClasificacion();";
 ...
 while($fila = mysqli_fetch_array($query)){
  ?>
    <tr> 
      ...
      <td>
      <a href="update/clase.php?id_clasificacion=<?php echo $fila['id_clasificacion']; ?>">
